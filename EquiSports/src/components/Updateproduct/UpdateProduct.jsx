    ...
    return (
        <div className="container mx-auto py-8">
            ...
            <form onSubmit={handleSubmit} className="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="mb-4">
                    <label htmlFor="stockStatus" className="block text-gray-700 font-bold">Stock Status</label>
                    <input
                        type="number"
                        id="stockStatus"
                        name="stockStatus"
                ...
                <div className="mb-4">
                    <label htmlFor="image" className="block text-gray-700 font-bold">Image URL</label>
                    <input
                        type="url"
                        id="image"
                        name="image"
