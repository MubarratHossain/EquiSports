...
const Footer = () => {
    return (
        <footer className="footer bg-gradient-to-r from-red-500 to-red-700 hover:from-red-600 hover:to-red-800 shadow-lg text-white p-10 rounded-lg mb-1">
            <aside>
                <svg
                    width="50"
                    height="50"
            ...
            <nav>
                ...
                <a className="link link-hover">Equestrian</a>
            </nav>
            <nav>
